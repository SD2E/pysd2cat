...
class LiveDeadPipeline:
    ...
    def condition_method(self, live_conditions=None, dead_conditions=None):
        ...
        if live_conditions is None:
            live_conditions = [{self.x_treatment: n.treatments_dict[self.x_treatment][0], n.time: n.time_points[-1]}]
        if dead_conditions is None:
            dead_conditions = [{self.x_treatment: n.treatments_dict[self.x_treatment][-1], n.time: n.time_points[-1]}]
